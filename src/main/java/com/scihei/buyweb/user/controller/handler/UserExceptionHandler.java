package com.scihei.buyweb.user.controller.handler;

import com.scihei.buyweb.common.service.exception.ServiceException;
import com.scihei.buyweb.common.HttpResultVO;
import com.scihei.buyweb.user.controller.UserAccountController;
import com.scihei.buyweb.user.controller.UserInfoController;
import lombok.extern.slf4j.Slf4j;
import org.springframework.web.bind.annotation.ControllerAdvice;
import org.springframework.web.bind.annotation.ExceptionHandler;
import org.springframework.web.bind.annotation.ResponseBody;
@Slf4j
@ControllerAdvice(assignableTypes = {UserInfoController.class, UserAccountController.class})
